...
valgrind:
	valgrind --leak-check=full --gen-suppressions=all --error-limit=no --track-origins=yes  --suppressions=.valgrindIgnore.supp --dsymutil=yes --show-reachable=yes --error-exitcode=0 -v ./Octree.out
